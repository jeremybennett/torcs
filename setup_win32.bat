...
if exist .\src\drivers\tutor call .\create_dir .\runtime
if exist .\src\drivers\tutor call .\create_dir .\runtime\drivers
if exist .\src\drivers\tutor call .\create_dir .\runtime\drivers\tutor
