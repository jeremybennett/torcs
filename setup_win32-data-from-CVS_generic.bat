...
if exist .\data\tracks\dirt-1\*.* call .\create_dir .\%RUNTIMEDIR%
if exist .\data\tracks\dirt-1\*.* call .\create_dir .\%RUNTIMEDIR%\tracks
if exist .\data\tracks\dirt-1\*.* call .\create_dir .\%RUNTIMEDIR%\tracks\dirt
if exist .\data\tracks\dirt-1\*.* call .\create_dir .\%RUNTIMEDIR%\tracks\dirt\dirt-1
if exist .\data\tracks\dirt-1\dirt-1.xml copy .\data\tracks\dirt-1\dirt-1.xml .\%RUNTIMEDIR%\tracks\dirt\dirt-1\dirt-1.xml
if exist .\data\tracks\dirt-1\background.png copy .\data\tracks\dirt-1\background.png .\%RUNTIMEDIR%\tracks\dirt\dirt-1\background.png
if exist .\data\tracks\dirt-1\dirt-1.ac copy .\data\tracks\dirt-1\dirt-1.ac .\%RUNTIMEDIR%\tracks\dirt\dirt-1\dirt-1.ac
if exist .\data\tracks\dirt-1\dirt-1.png copy .\data\tracks\dirt-1\dirt-1.png .\%RUNTIMEDIR%\tracks\dirt\dirt-1\dirt-1.png
