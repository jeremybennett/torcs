 ...
 */
extern "C" int
cylos1(tModInfo *modInfo)
{
    modInfo->name    = "cylos1";	/* name of the module (short) */
...
const  tdble PGain[1]    = {0.02f};
const  tdble AGain[10]    = {0.008f};
const  tdble PnGain[10]   = {0.02f};
const  tdble Advance[10]  = {35.0f};
const  tdble Advance2[10] = {20.0f};
const  tdble Advance3[10] = {200.0f};
const  tdble AdvStep[10]  = {20.0f};
...
static void initTrack(int index, tTrack* track, void *carHandle, void **carParmHandle, tSituation *s)
{
    ...
    sprintf(buf, "drivers/cylos1/tracksdata/car_%s", str);
    *carParmHandle = GfParmReadFile(buf, GFPARM_RMODE_STD);
    if (*carParmHandle == NULL) {
	*carParmHandle = GfParmReadFile("drivers/cylos1/car1.xml", GFPARM_RMODE_STD | GFPARM_RMODE_CREAT);
	GfOut("drivers/cylos1/car1.xml Loaded\n");
    } else {
	GfOut("%s Loaded\n", buf);
    }
    sprintf(buf, "drivers/cylos1/tracksdata/%s", str);
